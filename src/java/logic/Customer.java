...
public class Customer extends User implements Serializable {
    ...
    public Customer(int customerId, int userId, String name, String surname, String address, Date birthDate, String nationality, String phone, String username, String password) {
        super(userId, name, surname, address, birthDate, nationality, phone, username, password);
